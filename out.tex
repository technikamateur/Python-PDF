...
This report has been auto generated.\newline
\begin{itemize}
    \item Used compiler: gcc 10.7
    \item UDE version: 22.04
...
Commit deatils:
\begin{itemize}
    \item Fingerprint: c0499b982968a798620d66084295ed2c7a84488a
    \item Tag: v1.2
\end{itemize}
\subsubsection{Validation}
\begin{itemize}
    \item Signal length: 128
    \item Loop length: 100
\end{itemize}
